...
const App = ():JSX.Element =>{
  ...
  const addReadedBooks = (id:string):void => {
    ...
    const indexBook = newList.findIndex(({book:{ISBN}}) => ISBN ===id)
      ...
      <Grid container spacing={2} direction={{md: 'row'}}>
        <Grid item xs={12} sm={12} md={6} lg={8} xl={8} >
          <BooksLenght booksList={library}/>
            ...
            <SelectFilter genreBook={genreBook} handleChange={handleChange} />
          <Library library={library} onBooks={addReadedBooks} rate={rate} genreBook={genreBook} />
        </Grid>
        <Grid item xs={12} lg={4} xl={4} md={6} sm={12} style={{backgroundColor:'#333'}}>
